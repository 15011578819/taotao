...
var category = {OBJ: $("#_JD_ALLSORT"),
       ...
       /* var a, b = {}, c = $("#categorys-2013");
    	...
    	// });
    },FN_GetBrands: function() {      //  $.getJSONP(this.URL_BrandsServ, category.getBrandService)
      ...
      //  $.getJSONP(this.URL_BrandsServ, category.getBrandService)
        ...
        b.push('<html>' +
           /* '<head>contentType="text/html; charset=UTF-8"</head>' +*/
                ' <body>' +
                    '<div class="extra">' +
                        '<a {if pageConfig.isHome}clstag="homepage|keycount|home2013|0614a"{/if} href="http://www.jd.com/allSort.aspx">\u5168\u90e8\u5546\u54c1\u5206\u7c7b</a>' +
                    '</div>' +
                '</body>' +
            ' </html>'), this.OBJ.attr("load", "1").html(b.join("")), $.bigiframe(this.OBJ), this.FN_GetBrands();
